...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        mysqli_query($config, $query_new_loc);
        $id_ubicacion = mysqli_insert_id($config);

        $query_hotel = "INSERT INTO catalogo (propietario_uuid, nombre, descripcion, id_ubicacion) 
                        VALUES ('$propietario_uuid', '$nombre', '$descripcion', '$id_ubicacion')";
